...
pub const MENU_BG_COLOR: Color = Color::rgba(0.4, 0.2, 0.8, 0.2);
pub const NORMAL_BUTTON_COLOR: Color = Color::rgba(0.15, 0.15, 0.15, 0.5);
pub const HOVERED_BUTTON_COLOR: Color = Color::rgba(0.15, 0.25, 0.15, 0.75);
pub const PRESSED_BUTTON_COLOR: Color = Color::rgba(0.15, 0.35, 0.15, 0.75);
